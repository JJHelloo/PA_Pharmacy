...
public Prescription randomPrescription()
{
  ...
  //_drugID
  //pick random drug (must update prescription.java)

  //quantity 1-200

  //dateissued is generated by the database
  ...
  //pharmacy_id
  //pick random pharmacy (do we have any?)
  //can this be null? never specified in the alter table statement in Build_DB.sql
